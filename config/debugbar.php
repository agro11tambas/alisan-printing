...
return [
    ...
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | Debugbar is OFF unless DEBUGBAR_ENABLED=true is set explicitly.
     |
     | The package default is null, which makes Debugbar follow APP_DEBUG. That
     | turned it on in production, where it profiled every query and wrote a
     | ~100 KB JSON dump per request into storage/debugbar. Requests took
     | minutes. Never let APP_DEBUG alone decide this.
     |
