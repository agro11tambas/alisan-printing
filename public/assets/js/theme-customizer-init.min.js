...
$(function () {
    ...
    $(function () {
        ...
        a &&
            ...
            $('[data-app-header="app-header-light"]').on(
                "change",
                function (a) {
                    a.preventDefault();
                    a = $(this);
                    $("html")
                        .addClass("app-header-light")
                        .removeClass("app-header-dark"),
                        localStorage.setItem(
                            "app-header",
                            a.data("app-header")
                        );
            ...
            $('[data-app-header="app-header-dark"]').on("change", function (a) {
                ...
                a = $(this);
                $("html")
                    .addClass("app-header-dark")
                    .removeClass("app-header-light"),
    ...
    $(function () {
        ...
        a &&
            ($("html").addClass(a),
            $('[name="app-skin"][data-app-skin="' + a + '"]').prop(
                "checked",
                !0
            )),
            ...
            $('[data-app-skin="app-skin-dark"]').on("change", function (a) {
                ...
                a = $(this);
                $("html")
                    .addClass("app-skin-dark")
                    .removeClass("app-skin-light"),
                    localStorage.setItem("app-skin", a.data("app-skin"));
            }),
    ...
    $(function () {
        ...
        a &&
            ...
            $('[data-font-family="app-font-family-lato"]').on(
                "change",
                function (a) {
                    a.preventDefault();
                    a = $(this);
    ...
    $(function () {
        void 0 === window.localStorage && alert("Your browser is outdated!"),
            $("[data-style='reset-all-common-style']").on(
                "click",
                function (a) {
                    a.preventDefault(),
                        window.localStorage.removeItem("app-navigation"),
