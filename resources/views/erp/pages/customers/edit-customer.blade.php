                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone', $customer->phone) }}" placeholder="Phone">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                                    ...
                                    <div class="mb-3 row address-group">
                                        <div class="col-lg-5 mb-0">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="addresses[{{ $index }}][address]" value="{{ old("addresses.$index.address", $address->address) }}" placeholder="Address {{ $loop->iteration }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 mb-0">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-map-pin"></i></div>
                                                <input type="text" class="form-control" name="addresses[{{ $index }}][google_maps]" value="{{ old("addresses.$index.google_maps", $address->google_maps) }}" placeholder="Google Map {{ $loop->iteration }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <button type="button" class="btn btn-danger btn-remove {{ $loop->first ? 'd-none' : '' }}">
                                                <i class="feather-x"></i>
                                            </button>
                                        </div>
                                    </div>
    ...
    document.getElementById('add-address').addEventListener('click', function() {
        ...
        wrapper.innerHTML = `
            <div class="col-lg-5 mb-0">
                <div class="input-group">
                    <div class="input-group-text"><i class="feather-book"></i></div>
                    <input type="text" class="form-control" name="addresses[${addressIndex}][address]" placeholder="Address ${addressIndex + 1}">
                </div>
            </div>
            <div class="col-lg-5 mb-0">
                <div class="input-group">
                    <div class="input-group-text"><i class="feather-map-pin"></i></div>
                    <input type="text" class="form-control" name="addresses[${addressIndex}][google_maps]" placeholder="Google Map ${addressIndex + 1}">
                </div>
            </div>
            <div class="col-lg-2">
