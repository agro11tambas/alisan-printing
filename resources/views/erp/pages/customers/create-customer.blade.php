                                    ...
                                    <div class="address-item mb-2 row">
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="addresses[0][address]" value="{{ old('addresses.0.address') }}" placeholder="Address 1">
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-map-pin"></i></div>
                                                <input type="text" class="form-control" name="addresses[0][google_maps]" value="{{ old('addresses.0.google_maps') }}" placeholder="Google Map 1">
                                            </div>
                                        </div>
                                        <div class="col-lg-2 d-flex">
                                            <button type="button" class="btn btn-danger btn-remove d-none"><i class="feather-x"></i> Remove</button>
                                        </div>
                                    </div>
                                </div>
                                <button type="button" class="btn btn-success mt-2" id="add-address"><i class="feather-plus"></i> Add Address</button>
                            </div>
                        </div>
                    </div>
                </form>
