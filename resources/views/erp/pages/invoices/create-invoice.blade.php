    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card stretch stretch-full">
                <form action="/erp/invoices/store" method="POST" id="invoiceForm" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="card-body">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="account_number" name="account_number" value="{{ old('account_number') }}" placeholder="account_number">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
