...
<div class="main-content">
    <div class="row">
        <div class="col-12">
            <form action="/erp/orders/{{ $order->id }}" method="POST" id="orderForm">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            ...
                                            <select class="form-select form-control max-select" data-select2-selector="tag" id="transaction_type" name="transaction_type">
                                                ...
                                                $bg = $bgColors[$loop->index % count($bgColors)];
                                                @endphp
                                                <option value="{{ $transactionType->id }}" data-bg="{{ $bg }}" {{ $transactionType->id == $creditTransaction->account_id ? 'selected' : '' }}>{{ $transactionType->type }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            ...
                                            <select class="form-select form-control max-select" data-select2-selector="tag" name="cash_bank_account_id" id="cash_bank_account_id">
                                                ...
                                                $bg = $bgColors[$loop->index % count($bgColors)];
                                                @endphp
                                                <option value="{{ $cash->id }}" data-bg="{{ $bg }}" {{ $cash->id == $debitTransaction->account_id ? 'selected' : '' }}>Cash - {{ $cash->type }}</option>
                                                @endforeach
                                                @foreach ($bankAccounts as $bank)
                                                @php
                                                $bg = $bgColors[$loop->index % count($bgColors)];
                                                @endphp
                                                <option value="{{ $bank->id }}" data-bg="{{ $bg }}" {{ $bank->id == $debitTransaction->account_id ? 'selected' : '' }}>Bank - {{ $bank->type }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <select class="form-select form-control max-select" data-select2-selector="tag" id="payment_status" name="payment_status">
                                                ...
                                                <option value="Paid" data-bg="bg-success" {{ $order->payment_status == 'Paid' ? 'selected' : '' }}>Paid</option>
                                                <option value="Partially Paid" data-bg="bg-warning" {{ $order->payment_status == 'Partially Paid' ? 'selected' : '' }}>Partially Paid</option>
                                                <option value="Unpaid" data-bg="bg-danger" {{ $order->payment_status == 'Unpaid' ? 'selected' : '' }}>Unpaid</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        ...
                                        <span class="fw-semibold fs-12">Paid: Rp. {{ number_format($order->paid_amount, 2, ',', '.') }}</span>
                                    </div>
                                </div>
                                <div class="row mb-3 align-items-center">
                                    <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <select class="form-select form-control max-select" data-select2-selector="tag" id="tatus" name="status">
                                                <option disabled selected hidden>Choose Status</option>
                                                <option value="Draft" data-bg="bg-warning" {{ $order->status == 'Draft' ? 'selected' : '' }}>Draft</option>
                                                <option value="Sale List" data-bg="bg-dark" {{ $order->status == 'Sale List' ? 'selected' : '' }}>Sale List</option>
                                                <option value="Waiting List" data-bg="bg-primary" {{ $order->status == 'Waiting List' ? 'selected' : '' }}>Waiting List</option>
                                                <option value="Complete List" data-bg="bg-danger" {{ $order->status == 'Complete List' ? 'selected' : '' }}>Complete List</option>
                                                <option value="Delivered" data-bg="bg-info" {{ $order->status == 'Delivered' ? 'selected' : '' }}>Delivered</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
