                                    ...
                                    <tbody>
                                        @foreach ($deliveryOrder->items as $item)
                                            @php
                                                ...
                                                $availableBase = max($readyBase - ($deliveredBase + $shippingBase), 0);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="text-primary">{{ number_format($readyDisplay, 0, ',', '.') }}
                                                    </span>
                                                    /
                                                ...
                                                <td>
                                                    <input type="text" inputmode="numeric" class="form-control"
                                                        ...
                                                        max="{{ $availableDisplay }}" value="0">
                                                    <small class="text-muted remaining-info">Remaining:
                                                        {{ number_format($availableDisplay, 0, ',', '.') }}
                                                        {{ $item->unit_name }}
                                                    </small>
                                                </td>
