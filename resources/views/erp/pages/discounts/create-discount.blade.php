                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    <select class="form-select form-control max-select" data-select2-selector="tag" id="minimum_based_on" name="minimum_based_on">
                                        ...
                                        <option value="Quantity of Items" data-bg="bg-success">Quantity of Items</option>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    <div class="input-group-text"><i class="feather-dollar-sign"></i></div>
                                    <input type="text" class="form-control" id="minimum_qty_or_amount" name="minimum_qty_or_amount" value="{{ old('minimum_qty_or_amount') }}" placeholder="minimum_qty_or_amount">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        toggleApplyOn(); // Load kondisi awal
    });
