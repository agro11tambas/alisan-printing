        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <form action="/erp/products/categories/update/{{ $category->id }}" method="POST" id="categoryForm"
                                ...
                                <div class="col-lg-10 mb-0">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="slug" name="slug"
                                            value="{{ old('slug', $category->slug) }}" placeholder="slug" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-lg-10 mb-0">
                                    <div class="input-group">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="5" placeholder="Description"
                                            class="form-control">{{ strip_tags(old('description', $category->description)) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
