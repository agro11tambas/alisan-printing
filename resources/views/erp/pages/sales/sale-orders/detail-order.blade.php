...
<div class="page-header sticky-top">
    <div class="page-header-left d-flex align-items-center">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">Detail Sale Orders</li>
        </ul>
    </div>
    <!-- <div class="page-header-right ms-auto">
        <div class="page-header-right-items">
            ...
            <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                <a href="/erp/sales/create-order" class="btn btn-primary">
                    ...
                    <div class="card stretch">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2" class="border-0"></td>
                                            <td class="fw-semibold text-dark text-lg-end border-bottom text-end">Discount</td>
                                            <td class="fw-bold text-danger border-bottom text-end">- Rp. {{ number_format($order->discount ?? 0, 0, ',', '.') }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="border-0"></td>
                                            <td class="fw-semibold text-dark text-lg-end border-bottom text-end">Grand Total</td>
                                            <td class="fw-bold text-success border-bottom text-end">Rp. {{ number_format($order->grand_total ?? $totalAmount, 0, ',', '.') }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="card-footer">
                            <div class="row justify-content-end">
                                <div class="col-sm-3">
                                    <a href="/erp/sales/sale-orders/invoice/{{ $order->id }}" class="btn btn-primary">Print Invoice</a>
                                </div>
                            </div>
                        </div>
                    </div>
