            ...
            <div class="col-xxl-12 col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">
                            Payment History - Sale Return #{{ $saleReturn->order_number }}
                        </h5>
                    </div>
                    <div class="card-body">
                        @forelse($transactions as $groupId => $trxGroup)
                            @php
                                // filter hanya credit (Cash/Bank refund keluar uang)
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content bg-dark border-0">
                <div class="modal-body p-0 text-center position-relative">
                    ...
                    <img id="lightboxImage" src="" alt="Proof Preview" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    form.action = `/erp/sales/sale-return/update-payment/${groupId}`;
                });
            });
        });
        ...
        document.querySelector("#editPaymentForm").addEventListener("submit", function() {
