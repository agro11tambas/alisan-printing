            ...
            <div class="card stretch stretch-full">
                <div class="card-body p-0">
                    ...
                    <ul class="nav nav-tabs mb-3" id="saleReturnTabs" role="tabreturn">
                        <li class="nav-item">
                            <a class="nav-link active" id="sale-return-tab" data-bs-toggle="tab" href="#sale-return" role="tab">Sale Return</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="deleted-sale-return-tab" data-bs-toggle="tab" href="#deleted-sale-return" role="tab">Deleted Sale Return</a>
                        </li>
                    </ul>
                    <div class="table-responsive">
                        <!-- <table class="table table-hover" id="saleReturnTable">
                            <thead>
                                <tr>
                                    <th></th>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="refund_amount" name="refund_amount" value="0">
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        // Expand/collapse child row khusus kolom "dt-control" di Deleted Sale Return
        $('#deletedSaleReturnTable tbody').on('click', 'td.dt-control', function() {
            let tr = $(this).closest('tr');
            let row = deletedTable.row(tr);
            let icon = $(this).find('i');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.btn-mark-paid')) {
            ...
            // isi otomatis refund_amount sama dengan balance
    ...
    document.getElementById('markAsSaleForm').addEventListener('submit', function(e) {
        ...
        if (!refundAmount || isNaN(refundAmount) || parseInt(refundAmount) <= 0) {
            document.getElementById('error_refund_amount').innerText = 'Refund amount harus diisi dan lebih dari 0';
            ...
            document.getElementById('error_refund_amount').innerText = 'Refund amount tidak boleh melebihi Balance';
            document.getElementById('error_refund_amount').classList.remove('d-none');
            valid = false;
        }
        ...
        // set value bersih ke input sebelum submit
