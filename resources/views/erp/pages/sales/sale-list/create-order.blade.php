                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <select class="form-select" id="due_date_option" name="due_date_option" style="font-size: 14px;" required>
                                        ...
                                        <div id="custom_due_date_wrapper" class="mt-2">
                                            <input type="date" class="form-control" id="custom_due_date" name="custom_due_date" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            ...
                                            @endphp
                                            <select class="form-select max-select" data-select2-selector="tag" id="customers" name="customers[]" required>
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <select class="form-select max-select" data-select2-selector="tag" id="addresses" name="addresses[]" required>
                                    ...
                                    <table class="table table-bordered overflow-hidden" id="tab_logic">
                                        ...
                                        <tbody id="tab_logic_body">
                                            <tr id="addr0">
                                                ...
                                                <input type="hidden" name="product_type[]" class="form-control product-type" id="product_type_0" readonly>

                                                <td><input type="number" name="qty[]" class="form-control qty" id="qty_0" min="1" value="1"></td>
                                                ...
                                                <input type="hidden" name="price_after_discount[]" class="form-control price_after_discount" id="price_after_discount_0" readonly>
                                                <input type="hidden" name="total_after_discount[]" class="form-control total_after_discount" id="total_after_discount_0" readonly>
                                            </tr>
...
<script>
        ...
        allDiscounts.forEach(discount => {
            ...
            if (discount.apply_on === 'Product') {
                if (discount.minimum_based_on === 'Quantity of Items' && qty >= discount.minimum_qty_or_amount) {
                    eligible = true;
                } else if (discount.minimum_based_on === 'Purchase Amount' && totalBeforeDiscount >= discount.minimum_qty_or_amount) {
                    eligible = true;
                }
                ...
                if (discount.minimum_based_on === 'Quantity of Items' && totalQtyCategory >= discount.minimum_qty_or_amount) {
                    eligible = true;
                } else if (discount.minimum_based_on === 'Purchase Amount' && totalAmountCategory >= discount.minimum_qty_or_amount) {
                    eligible = true;
                }
            }
    ...
    $(document).on("change input", "#customers, #addresses, select[name='product[]'], input[name='qty[]'], input[name='order_date']", function() {
    ...
    $(document).ready(function() {
        $('#customers').on('change', function() {
            ...
            addresses.forEach((address, i) => {
                $('#addresses').append(`<option value="${address.id}" data-map="${address.google_maps}">Alamat ke-${i+1} - ${address.address}</option>`);
            });
        });
