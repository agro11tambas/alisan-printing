            ...
            <div class="card stretch stretch-full">
                <div class="card-body p-0">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="due_date_order" class="form-control d-none" style="padding: 0.5rem 1rem;">
                    ...
                    <ul class="nav nav-tabs mb-3" id="saleListTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="sale-list-tab" data-bs-toggle="tab" href="#sale-list" role="tab">Sale List</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="deleted-sale-list-tab" data-bs-toggle="tab" href="#deleted-sale-list" role="tab">Deleted Sale List</a>
                        </li>
                    </ul>
        ...
        <form method="POST" id="formDeleteOrder">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p style="font-size: 16px;">2. Jika ada kesalahan saat audit. Anda siap untuk Bertanggung Jawab ? Kolom Keterangan (Wajib diisi)</p>
                    <div class="form-group mt-3">
                        <label for="delete_notes" class="fw-semibold">Keterangan <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="delete_notes" name="delete_notes" rows="3" required placeholder="Tuliskan alasan penghapusan..."></textarea>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="paid_amount" name="paid_amount" value="0" required>
                            </div>
...
<div class="modal fade" id="modalForceDeleteOrder" tabindex="-1" aria-labelledby="forceDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="formForceDeleteOrder">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin <strong>menghapus permanen</strong> Order <strong id="ForceOrderName"></strong>?</p>
...
<div class="modal fade" id="modalRestoreOrder" tabindex="-1" aria-labelledby="restoreModalLabel" aria-hidden="true">
    <div class="modal-dialog">
...
<div class="modal fade-scale" id="modalReturnMoney" tabindex="-1" aria-labelledby="modalReturnMoneyLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <!--! BEGIN: [modal-header] !-->
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row g-3 mb-3">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="date" id="return_transaction_date" name="transaction_date" class="form-control"
                                    value="{{ date('Y-m-d') }}">
                            </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <select class="form-select form-control max-select" data-select2-selector="tag" name="cash_bank_account_id" id="return_cash_bank_account_id">
                                    <option value="" disabled selected hidden>Pilih Bank atau Cash Account</option>
                                    @php
                                    $bgColors = ['bg-danger', 'bg-warning', 'bg-primary', 'bg-indigo', 'bg-success'];
                                    @endphp
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="return_amount" name="return_amount" value="0" required>
                            </div>
...
<script>
    ...
    document.getElementById('formReturnMoney').addEventListener('submit', function(e) {
        ...
        if (!transactionDate) {
            document.getElementById('error_return_transaction_date').innerText = 'Tanggal transaksi wajib diisi';
            document.getElementById('error_return_transaction_date').classList.remove('d-none');
            valid = false;
        }

        if (!cashBankAccount) {
            document.getElementById('error_return_cash_bank_account_id').innerText = 'Pilih cash atau bank account';
        ...
        if (!returnAmount || isNaN(returnAmount) || parseInt(returnAmount) <= 0) {
            document.getElementById('error_return_amount').innerText = 'Return amount harus diisi dan lebih dari 0';
