                                    ...
                                    <table class="table table-bordered overflow-hidden" id="tab_logic">
                                        ...
                                        <tbody id="tab_logic">
                                            ...
                                            <tr id="addr{{ $index }}">
                                                ...
                                                {{-- Hidden fields --}}
                                                <input type="hidden" name="price_after_discount[]" class="form-control price_after_discount" id="price_after_discount_{{ $index }}" value="{{ $item->price_after_discount }}" readonly>
                                                <input type="hidden" name="total_after_discount[]" class="form-control total_after_discount" id="total_after_discount_{{ $index }}" value="{{ $item->total_after_discount }}" readonly>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
