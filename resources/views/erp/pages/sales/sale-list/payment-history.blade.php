...
@push('modals')
    <div class="modal fade-scale" id="modalEditPayment" tabindex="-1" aria-labelledby="modalEditPaymentLabel"
        aria-hidden="true">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (pasteArea) {
                ...
                pasteArea.addEventListener('paste', (e) => {
                    // Jika user sedang paste di input catatan → JANGAN intercept
                    if (e.target.classList.contains('note-input')) {
                        return; // biarkan paste normal
                    }

                    e.preventDefault(); // hanya blok kalau bukan paste ke note input
