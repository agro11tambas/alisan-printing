        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <form action="/erp/products/product-bundles/store-more-product/{{ $primaryItem->product_id }}"
                        method="POST" id="productBundleForm">
                        @csrf
                        <div class="card-body">
                            @php
                                $primaryItem = old('primary_product_id') ? $primaryItem : $primaryItem;
                                $secondaryItems = old('secondary_product_ids')
                                    ? collect(old('secondary_product_ids'))
                                    : $secondaryItems;
                            @endphp
