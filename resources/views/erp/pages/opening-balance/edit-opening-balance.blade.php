                            ...
                            <table class="table table" id="openingBalanceList">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" name="accounts[{{ $account->id }}][debit]" value="{{ $account->opening_debit }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control" name="accounts[{{ $account->id }}][credit]" value="{{ $account->opening_credit }}">
                                        </td>
                                    </tr>
                                    @endforeach
                                    <tr>
