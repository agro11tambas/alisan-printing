        ...
        <div class="page-header-right-items">
            ...
            <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                ...
                <button type="submit" class="btn btn-primary" form="purchaseProductForm">
                    ...
                    <span>Edit Purchase Product</span>
                </button>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card stretch stretch-full">
                <form action="/erp/purchase-products/update/{{ $purchaseProduct->id }}" method="POST" id="purchaseProductForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $purchaseProduct->name) }}" placeholder="Name">
                                </div>
                            </div>
                        </div>
                    </div>
