                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end" id="SaleReturnDisplay">(Rp {{ number_format($saleReturn ?? 0, 0) }})</td>
                                </tr>
                                <tr>
                                    <td><strong>Gross Profit</strong></td>
                                    <td class="text-end" id="GrossProfitDisplay">Rp {{ number_format($grossProfit, 0) }}</td>
                                </tr>
                                <tr>
                                    <td>Less: Expenses</td>
                                ...
                                <tr class="table-success">
                                    ...
                                    <td class="text-end" id="NetProfitDisplay"><strong>Rp {{ number_format($netProfit, 0) }}</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    function fetchProfitLoss(filter, start = '', end = '') {
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#NetProfitDisplay').text('Rp ' + formatRupiah(res.netProfit));
            }
        });
    }
