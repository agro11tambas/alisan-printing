        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <form action="/erp/shop-manager/operators/update/{{ $operator->id }}" method="POST" id="OperatorForm">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-lg-10 mb-0">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name', $operator->name) }}"
                                        placeholder="Name">
                                    @error('name')
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-lg-10 mb-0">
                                    <select name="active" id="active"
                                        ...
                                        <option value="1"
                                            {{ old('active', $operator->active) == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0"
                                            {{ old('active', $operator->active) == 0 ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                    @error('active')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
