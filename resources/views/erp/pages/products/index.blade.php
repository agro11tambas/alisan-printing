                        ...
                        <div class="col-lg-4 me-2">
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    ...
                                    <select name="category_id[]" id="category_id" class="form-control" style="padding: 0.5rem 1rem !important; font-size: 0.875rem !important;" data-select2-selector="tag">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="tag_id[]" id="tag_id" class="form-control" style="padding: 0.5rem 1rem !important; font-size: 0.875rem !important;" data-select2-selector="tag">
                                        <option value="" selected>All</option>
                                        @foreach ($tags as $tag)
                                        <option value="{{ $tag->id }}" data-bg="bg-success">{{ $tag->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
        ...
        $(document).on('click', function(e) {
            if (!$(e.target).closest('#productTable tbody tr, #productTableMobile tbody tr').length) {
                $('#productTable tbody tr.shown, #productTableMobile tbody tr.shown').each(function() {
                    var tr = $(this);
                    var table = tr.closest('table').attr('id') === 'productTable' ? dataTable : dataTableMobile;
