    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card stretch stretch-full">
                <form action="/erp/products/tags/update/{{ $tag->id }}" method="POST" id="tagForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $tag->name) }}" placeholder="Name">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $tag->slug) }}" placeholder="slug" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="5" placeholder="Description" class="form-control">{{ strip_tags(old('description', $tag->description)) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
