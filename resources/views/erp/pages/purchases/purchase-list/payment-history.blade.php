            ...
            <div class="col-xxl-12 col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">
                            Payment History - Purchase #{{ $purchase->purchase_number }}
                        </h5>
                    </div>
                    <div class="card-body">
                        @forelse($transactions as $groupId => $trxGroup)
                            ...
                            @endif
                        @empty
                            <p class="text-muted">Belum ada pembayaran untuk purchase ini.</p>
                        @endforelse
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" id="editPaymentForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="payment_proof_preview" class="d-flex gap-2 flex-wrap mb-2"></div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-edit-payment').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    form.action = `/erp/purchases/purchase-list/update-payment/${groupId}`;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (pasteArea) {
                ...
                pasteArea.addEventListener('paste', (e) => {
                    // 🔥 Kalau user paste DI INPUT NOTE → biarkan normal
                ...
                fetch(`/erp/purchases/purchase-list/verify-payment/${groupId}`, {
                    ...
                    .then(async (res) => {
                        ...
                        if (groupBox) {
                            ...
                            // ubah tombol Verify jadi Verified
                            const btnVerify = groupBox.querySelector('.btn-verify-payment');
                            if (btnVerify) {
