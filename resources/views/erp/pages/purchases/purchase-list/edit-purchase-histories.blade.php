                                ...
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-danger">{{ formatChangeValue($purchaseChanges['old'][$field] ?? '-') }}</td>
                                            <td class="text-success">{{ formatChangeValue($newValue) }}</td>
                                        </tr>
                                        @endif
                                        @endforeach
                                            ...
                                            <td>
                                                ...
                                                <table class="table table-sm table-bordered mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>{{ ucfirst(str_replace('_',' ', $field)) }}</td>
                                                            <td class="text-danger">{{ formatChangeValue($values['old']) }}</td>
                                                            <td class="text-success">{{ formatChangeValue($values['new']) }}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="table table-sm table-bordered mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Quantity</td>
                                                            <td class="text-danger">{{ formatChangeValue($item['old_quantity']) }}</td>
                                                            <td class="text-success">{{ formatChangeValue($item['new_quantity']) }}</td>
                                                        </tr>
                                                        @endif

                                                        @if(isset($item['old_total']) && isset($item['new_total']))
                                                        <tr>
                                                            <td>Total</td>
