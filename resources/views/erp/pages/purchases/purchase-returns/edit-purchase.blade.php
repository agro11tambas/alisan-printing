                                        ...
                                        <div class="col-lg-10 mb-0">
                                            <div class="input-group">
                                                <input type="datetime-local" class="form-control" id="return_date"
                                                    name="return_date"
                                                    value="{{ old('return_date', isset($purchaseReturn->return_date) ? \Carbon\Carbon::parse($purchaseReturn->return_date)->format('Y-m-d\TH:i') : date('Y-m-d\TH:i')) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="product-grid">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" inputmode="numeric" name="freight[]"
                                                        class="form-control freight" id="freight_{{ $index }}"
