    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card stretch stretch-full">
                <form action="/erp/warehouses/update/{{ $warehouse->id }}" method="POST" id="warehouseForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    <select class="form-control select-product" data-select2-selector="status" name="product" id="product">
                                        ...
                                        <option value="{{ $product->id }}" data-price="{{ $product->price }}" {{ $product->id == $warehouse->purchase_product_id ? 'selected' : '' }}>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    <select class="form-control form-select fs-13" id="stock" name="stock">
                                        ...
                                        <option value="masuk" {{ $warehouse->barang_masuk > 0 ? 'selected' : '' }}>Barang Masuk</option>
                                        <option value="keluar" {{ $warehouse->barang_keluar > 0 ? 'selected' : '' }}>Barang Keluar</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center d-none" id="form_barang_masuk">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="barang_masuk" name="barang_masuk" value="{{ old('barang_masuk', $warehouse->barang_masuk) }}" placeholder="Stock In">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center d-none" id="form_barang_keluar">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    <div class="input-group-text"><i class="feather-layers"></i></div>
                                    <input type="text" class="form-control" id="barang_keluar" name="barang_keluar" value="{{ old('barang_keluar', $warehouse->barang_keluar) }}" placeholder="Stock Out">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    <input type="date" class="form-control" id="date_change" name="date_change" value="{{ old('date_change', $warehouse->date_change ? \Carbon\Carbon::parse($warehouse->date_change)->format('Y-m-d') : '') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    ...
                                    <textarea name="note" id="note" cols="30" rows="5" placeholder="Note" class="form-control" value="{{ old('note') }}">{{ strip_tags(old('note', $warehouse->note)) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
