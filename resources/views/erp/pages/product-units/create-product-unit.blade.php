    ...
    <div class="page-header sticky-top">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Create Product Unit</li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <form action="/erp/products/units/store" method="POST" id="productUnitForm">
                        @csrf
                        @method('POST')
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-10 mb-0">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ old('name') }}" placeholder="Contoh: Pcs, Dus, Pack, Kg, Meter">
                                    </div>
                            ...
                            <div class="alert alert-soft-primary mt-4 mb-0">
                                ...
                                <div>
                                    Di halaman ini cukup buat master satuan seperti
                                    <strong>Pcs</strong>, <strong>Dus</strong>, <strong>Pack</strong>,
                                    <strong>Kg</strong>, atau <strong>Meter</strong>.
                                </div>
                                <div>
                                    Konversi seperti <strong>1 Dus = 1000 pcs</strong> dan harga per unit
                                    nanti diatur saat create/edit product.
                                </div>
                            </div>
                        </div>
                    </form>
