        ...
        function fetchAccount(filter, start = '', end = '') {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#SaleListDisplay').text('Rp ' + formatRupiah(response.totalSaleList));
                    $('#SaleOrderListDisplay').text(response.totalSaleOrderList);
                    $('#SaleOrderCount').text(response.countSaleOrder);
                    $('#SaleListCount').text(response.countSaleList);
                    ...
                    $('#PurchaseListDisplay').text('Rp ' + formatRupiah(response.totalPurchaseList));
                    $('#PurchaseOrderListDisplay').text(response.totalPurchaseOrderList);
                    $('#PurchaseOrderCount').text(response.countPurchaseOrder);
                    $('#PurchaseListCount').text(response.countPurchaseList);
