                                ...
                                <tbody>
                                    @foreach ($stockOut->items as $item)
                                        <tr>
                                            ...
                                            <td><span
                                                    class="fw-bold text-success">{{ number_format($item->stock_out, 0, ',', '.') }}</span>
                                            </td>
                                            <td>
                    ...
                    <div class="card-body task-info">
                        <div class="task-info-list">
                            ...
                            <div class="row align-items-center mb-3 task-list-row">
                                ...
                                <div class="col-6 d-flex">
                                    <span
                                        class="border-bottom border-bottom-dashed border-gray-5">{{ date('d M Y', strtotime($stockOut->date)) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
