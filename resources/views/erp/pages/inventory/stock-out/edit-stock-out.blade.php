...
@section('content')
    <div class="main-content m-0 m-md-2 m-lg-2 p-0 p-md-0 p-lg-0 pt-1 pt-md-0">
        <div class="row">
            <div class="col-12">
                <form action="/erp/inventory/stock-out/update/{{ $inventory->id }}" method="POST"
                    enctype="multipart/form-data" id="stockOutForm">
                    @csrf
                    @method('PUT')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="number" class="form-control"
                                                    ...
                                                    value="{{ $item->stock_out }}" min="0"
                                                    max="{{ $item->quantity }}">
                                                <small class="text-muted">Sisa:
                                                    {{ $item->quantity - $item->stock_out }}</small>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
