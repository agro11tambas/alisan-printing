...
<div class="main-content">
    <div class="row">
        <div class="col-12">
            <form action="/erp/inventory/stock-out/store/{{ $stockOut->id }}" method="POST" id="stockOutForm" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <input type="date" class="form-control" id="change_date" name="change_date" value="{{ now()->format('Y-m-d') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="waybill_number" name="waybill_number" value="{{ $stockOut->waybill_number }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <input type="file" class="form-control" id="waybill_image" name="waybill_image" accept="image/*" value="{{ old('waybill_image') }}">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="number"
                                            ...
                                            class="form-control"
                                            value="{{ $item->quantity - $item->stock_out }}"
                                            min="0"
                                            max="{{ $item->quantity - $item->stock_out }}"
