...
<div class="main-content">
    <div class="row">
        <div class="col-12">
            <form action="/erp/inventory/stock-in/store/{{ $stockIn->id }}" method="POST" id="stockInForm" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="waybill_number" name="waybill_number" value="{{ $stockIn->waybill_number }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3 align-items-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted">Sisa: {{ $item->quantity - $item->stock_in }}</small>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
