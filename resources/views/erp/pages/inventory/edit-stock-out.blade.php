...
<div class="main-content">
    <div class="row">
        <div class="col-12">
            <form action="/erp/inventory/stock-out/update/{{ $stockOut->id }}" method="POST" id="stockInForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <input type="date" class="form-control" id="change_date" name="change_date"
                                                value="{{ old('change_date', \Carbon\Carbon::parse($stockOut->change_date)->format('Y-m-d')) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="notes" name="notes" value="{{ old('notes', $stockOut->notes) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr id="addr{{ $index }}">
                                                ...
                                                <td>
                                                    <select class="form-control select-product" data-select2-selector="status" name="product[]" id="product_{{ $index }}">
                                                        <option value="" disabled {{ !$history->product_id ? 'selected' : '' }}>Pilih produk</option>
                                                ...
                                                <td>
                                                    <input type="number" name="stock[]" class="form-control stock" id="stock_{{ $index }}"
                                                        value="{{ $history->product->stock ?? 0 }}" readonly>
                                                </td>
                                                <td>
                                                    <input type="number" name="stock_out[]" class="form-control stock_out" id="stock_out_{{ $index }}"
                                                        value="{{ $history->stock_out }}">
                                                </td>
                                                <td>
                                                    <input type="number" name="remaining[]" class="form-control remaining text-danger" id="remaining_{{ $index }}"
                                                        value="{{ ($history->product->stock ?? 0) - $history->stock_out }}" readonly>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
