    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card stretch stretch-full">
                <form action="/erp/accounts/store" method="POST" id="accountForm">
                    @csrf
                    @method('POST')
                    <div class="card-body">
                            ...
                            <div class="col-lg-10 mb-0">
                                <div class="input-group">
                                    <select class="form-select form-control max-select" data-select2-selector="tag" id="name" name="name">
                                        ...
                                        <option value="Bank" data-bg="bg-success">Bank</option>
                                        <option value="Cash" data-bg="bg-primary">Cash</option>
                                        <!-- <option value="Sale" data-bg="bg-dark">Sale</option>
                                        <option value="Purchase" data-bg="bg-teal">Purchase</option> -->
                                        <option value="Expense" data-bg="bg-warning">Expense</option>
                                        <!-- <option value="Capital" data-bg="bg-danger">Capital</option> -->
                                    </select>
                                </div>
                            </div>
                        </div>
