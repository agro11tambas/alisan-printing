...
<div class="main-content">
    <div class="row">
        <div class="col-12">
            <form action="/erp/productions/material-request/update/{{ $materialRequest->id }}" method="POST" id="requestStockForm">
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="requested_by" name="requested_by" value="{{ Auth::user()->name }}" required readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-10 mb-0">
                                        <div class="input-group">
                                            <input type="date" class="form-control" id="requested_at" name="requested_at" value="{{ old('requested_at', isset($materialRequest->requested_at) ? \Carbon\Carbon::parse($materialRequest->requested_at)->format('Y-m-d') : date('Y-m-d')) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr id="row{{ $i }}">
                                                ...
                                                <td>
                                                    <input type="number" name="qty[]"
                                                        ...
                                                        min="1"
                                                        value="{{ $item->requested_qty }}" required>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
