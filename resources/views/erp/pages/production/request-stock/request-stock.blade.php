            ...
            <div class="card stretch stretch-full">
                <div class="card-body p-0">
                    ...
                    <ul class="nav nav-tabs mb-3" id="saleListTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="request-stock-tab" data-bs-toggle="tab" href="#request-stock" role="tab">Request Stock</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="deleted-request-stock-tab" data-bs-toggle="tab" href="#deleted-request-stock" role="tab">Deleted Request Stock</a>
                        </li>
                    </ul>
...
@push('modals')
<div class="modal fade" id="modalDeleteRequestStock" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <form method="POST" id="formChangeStatus">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin Mengubah Status RequestStock <strong id="RequestStockName"></strong>?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-md" data-bs-dismiss="modal">Batal</button>
...
<div class="modal fade" id="modalForceDeleteRequestStock" tabindex="-1" aria-labelledby="forceDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="formForceDeleteRequestStock">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin <strong>menghapus permanen</strong> RequestStock <strong id="ForceRequestStockName"></strong>?</p>
...
<div class="modal fade" id="modalRestoreRequestStock" tabindex="-1" aria-labelledby="restoreModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="formRestoreRequestStock">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin mengembalikan Request Stock <strong id="RestoreRequestStockName"></strong>?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-md" data-bs-dismiss="modal">Batal</button>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', function(e) {
            if (!$(e.target).closest('#requestStockTable tbody tr, #requestStockTableMobile tbody tr').length) {
                $('#requestStockTable tbody tr.shown, #requestStockTableMobile tbody tr.shown').each(function() {
                    var tr = $(this);
