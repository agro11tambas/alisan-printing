        ...
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                <div class="d-flex align-items-center gap-2">
                    <a href="/erp/productions/waiting-list-old" class="btn btn-light-brand">
...
@section('content')
    ...
    <div class="main-content m-0 m-md-2 m-lg-2 p-0 p-md-0 p-lg-0 pt-1 pt-md-0">
        <div class="row">
            <div class="col-12">
                {{-- 🔧 Assign versi lama: pilih Operator per produk, bukan Mesin --}}
                <form action="/erp/productions/waiting-list-old/assign/{{ $progress->id }}" method="POST"
                    id="assignForm">
                    @csrf
                    @method('POST')
                    <div class="row">
