    ...
    <div class="page-header sticky-top">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Assign List Old</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="/erp/welcome">Home</a></li>
                <li class="breadcrumb-item">Production</li>
                <li class="breadcrumb-item">Assign List Old</li>
            </ul>
        </div>
    </div>
@endsection
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive">
                            <div class="tab-content">
                                {{-- Tab 1: Assign List (design lama → satu baris per invoice) --}}
        ...
        $(document).ready(function() {
            ...
            function loadMoreData() {
                ...
                currentRequest = $.ajax({
                    ...
                    type: 'GET',
                    data: {
                        // 🔧 minta action button versi lama (Add Progress & Edit per invoice)
                        legacy: 1,
            ...
            $('#assignBatchTable').closest('.dataTables_wrapper').find('.dataTables_scrollBody')
                .on('scroll', function() {
            ...
            // 🔹 Klik baris invoice → tampilkan action button
