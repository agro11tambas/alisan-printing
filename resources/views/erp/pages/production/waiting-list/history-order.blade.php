                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-success">{{ $item->completed_quantity }}</span></td>
                                    <td>
                                        <span class="fw-bold text-danger">
                                            {{ $item->quantity - $item->completed_quantity }}
                                        </span>
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    <div class="task-info-list">
                        <div class="row align-items-center mb-3 task-list-row">
                            ...
                            <div class="col-6 d-flex">
                                <span class="border-bottom border-bottom-dashed border-gray-5">{{ $progress->order->customer->name }}</span>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3 task-list-row">
                            <div class="col-6">
                            ...
                            <div class="col-6 d-flex">
                                <span class="border-bottom border-bottom-dashed border-gray-5">{{ $progress->order->customer->phone }}</span>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3 task-list-row">
                            <div class="col-6">
                            ...
                            <div class="col-6 d-flex">
                                <span class="border-bottom border-bottom-dashed border-gray-5">{{ $progress->order->shipping_address }}</span>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3 task-list-row">
                            <div class="col-6">
                            ...
                            <div class="col-6 d-flex">
                                <span class="border-bottom border-bottom-dashed border-gray-5"><a href="{{ $progress->order->google_maps }}" target="_blank">Link Google Map</a></span>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3 task-list-row">
                            <div class="col-6">
                            ...
                            <div class="col-6 d-flex">
                                <span class="border-bottom border-bottom-dashed border-gray-5">{{ date('d M Y', strtotime($progress->order->created_at)) }}</span>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3 task-list-row">
                            <div class="col-6">
                            ...
                            <div class="col-6 d-flex">
                                <span class="border-bottom border-bottom-dashed border-gray-5">{{ $progress->order->status }}</span>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3 task-list-row">
                            <div class="col-6">
                            ...
                            <div class="col-6 d-flex">
                                <span class="border-bottom border-bottom-dashed border-gray-5">{{ $progress->order->payment_method }}</span>
                            </div>
                        </div>
                        <div class="row align-items-center task-list-row">
                            ...
                            <div class="col-6 d-flex">
                                <span class="border-bottom border-bottom-dashed border-gray-5">{{ $progress->order->payment_status }}</span>
                            </div>
                        </div>
                        <!-- <div class="row align-items-center mb-3 task-list-row">
                            <div class="col-6">
