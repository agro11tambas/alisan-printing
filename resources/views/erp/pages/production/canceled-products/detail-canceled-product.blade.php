                ...
                <div class="modal-body">
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="canceled_product" name="canceled_product" class="form-control" value="0">
                            </div>
...
<script>
    $(document).ready(function() {
        let dataTable = $('#canceledDetailTable').DataTable({
            ...
            info: false,
            pagingType: "simple",
            ajax: "{{ url('/erp/productions/canceled-products/detail/'.$productionStock->id.'/data') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
