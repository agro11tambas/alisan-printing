    ...
    <div class="page-header sticky-top">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Customer Deposit</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="/erp/welcome">Home</a></li>
                <li class="breadcrumb-item">Customer Deposit</li>
            </ul>
        </div>
                            ...
                            <div class="row g-3 justify-content-end">
                                <div class="col-md-6">
                                    ...
                                    <select id="search_account_type" name="search_account_type" class="form-control"
                                        style="padding: 0.5rem 1rem; font-size: 0.875rem;" data-select2-selector="status">
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadMoreData() {
                ...
                $.ajax({
                    url: "{{ url('/erp/accounts/customer-deposit/data') }}",
                    type: 'GET',
                    data: {
