...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // ====================================================
            // 🔹 INISIALISASI DATATABLE (SESUAI ASLI)
            // ====================================================
            ...
            // ====================================================
            // 🔹 FUNGSI LOAD DATA (PER 20 RECORD)
            // ====================================================
            function loadMoreData() {
                ...
                $.ajax({
                    url: "{{ url('/erp/accounts/purchase/data') }}",
                    type: 'GET',
                    data: {
            ...
            // ====================================================
            // 🔹 SCROLL DETECTION UNTUK INFINITE LOAD
            // ====================================================
            ...
            // ====================================================
            // 🔹 FILTER & SEARCH (ASLI, TIDAK DIUBAH)
            // ====================================================
