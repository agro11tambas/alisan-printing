    ...
    <div class="page-header sticky-top">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Capital</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="/erp/welcome">Home</a></li>
                <li class="breadcrumb-item">Capital</li>
            </ul>
        </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // ====================================================
            // 🔹 INISIALISASI DATATABLE (TETAP SEPERTI ASLI)
            // ====================================================
            ...
            // ====================================================
            // 🔹 FUNGSI LOAD DATA (BATCH 20 PER REQUEST)
            // ====================================================
            function loadMoreData() {
                ...
                $.ajax({
                    url: "{{ url('/erp/accounts/capital/data') }}",
                    type: 'GET',
                    data: {
            ...
            // ====================================================
            // 🔹 FILTER & SEARCH (TIDAK DIUBAH DARI ASLI)
            // ====================================================
